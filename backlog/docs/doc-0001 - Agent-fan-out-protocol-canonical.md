...
---
> Imported verbatim from the canonical fan-out sourcebook on 2026-08-14.
> This in-repo copy is authoritative for this repository. Do not summarise, compress or
> excerpt it; when the source changes, re-import it here in the same change.
