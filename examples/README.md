...
| [project-content](catalog/project-content/) | Apply bounded content to an existing project stack and central stack | Namespace-bound platform profile authorizing both stacks, project-label equality, and the content set |
| [external-project](catalog/external-project/) | Map a consuming-platform project CR into a reviewed stack request | External adapter, organization registry, target namespace, and pull-request approval seam |
