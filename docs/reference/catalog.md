...
| [stack-consumer](../../examples/catalog/stack-consumer/) | Consume an existing Grafana Cloud stack without a local stack claim, using an observed provider-assigned ID | Namespace-bound platform profile, authorized stack slug and region, and healthy organization ProviderConfig |
| [external-project](../../examples/catalog/external-project/) | Consuming-platform project CR mapped into a reviewed stack request | External adapter, organization registry, target namespace, and pull-request approval seam |
| [project-content](../../examples/catalog/project-content/) | Bounded content across an existing project stack and central stack | Namespace-bound platform profile authorizing both stacks, project-label equality, and the content set |
